...
## 
## For the mesh input, there are three cases:
## - Rectangular tissue [rect]
## - Spherical tissue [sphere]
## - Wingdisc tissue [wingd]
## These files are saved in the style ref_mesh_input_to_sim_XXXX where XXXX is replaced with the corresponding string in parentheses above.
##
