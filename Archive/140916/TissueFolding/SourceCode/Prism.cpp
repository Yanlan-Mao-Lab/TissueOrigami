...
Prism::Prism(int* tmpNodeIds, vector<Node*>& Nodes, int CurrId){
	...
	PlasticStrainsToAddInGrowthAxes = new double[3];
	for (int i=0; i<3; ++i){
		CurrGrowthStrainAddition[i] = 0;
		PlasticStrainsToAddInGrowthAxes[i] =0;
		GrowthRate[i] = 0;
		ShapeChangeRate[i] =0;
	}
	IsGrowing = false;
	...
	CurrGrowthStrainsInGrowthAxesMat= boost::numeric::ublas::zero_matrix<double>(3,3);
	CurrShapeChangeStrainsInGrowthAxesMat= boost::numeric::ublas::zero_matrix<double>(3,3);
	CurrPlasticStrainsInGrowthAxesMat= boost::numeric::ublas::zero_matrix<double>(3,3);
	...
	RefToGrowthRotMat = boost::numeric::ublas::zero_matrix<double>(3,3);
	RefToGrowthRotMatT = boost::numeric::ublas::zero_matrix<double>(3,3);
