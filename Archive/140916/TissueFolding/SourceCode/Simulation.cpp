...
void Simulation::updateTensionCompressionFromSave(){
	...
	for (int i=0;i<n;++i){
		...
		saveFileToDisplayTenComp.read((char*) &Elements[i]->PlasticStrain(0), sizeof Elements[i]->PlasticStrain(0));
		saveFileToDisplayTenComp.read((char*) &Elements[i]->PlasticStrain(1), sizeof Elements[i]->PlasticStrain(1));
		saveFileToDisplayTenComp.read((char*) &Elements[i]->PlasticStrain(2), sizeof Elements[i]->PlasticStrain(2));
	}
}
