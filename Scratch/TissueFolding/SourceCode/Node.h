...
public:
	...
	std::array<double,3> 	maximumExternalViscosity;			///< Minimum external viscosity of the node as a result of perturbation and modifications
	std::array<double,3> 	minimumExternalViscosity;			///< Maximum external viscosity of the node as a result of perturbation and modifications
	...
	int						coveringEllipseBandId;				///< The id of the marker ellipse that the node is covered by. If the node is not covered by any marker ellipse, the value is -1.
	bool					allOwnersECMMimicing;				///< The boolean stating all the elements making use of the node are ECM mimicking elements.
	bool 					facingLumen;						///< The boolean stating if the node is facing the lumen or not.c
	...
	bool					attachedToPeripodial;				///< The boolean stating if the node is attached to peripodial membrane.
