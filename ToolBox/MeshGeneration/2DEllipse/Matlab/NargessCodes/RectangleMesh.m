...
fclose(fileID);
%% 20210705 96h wing disc experimental measures - small mesh - symmetricY - positive coordinates
clear all
close all
...
borderNodes=borderNodes+[1 0];
surfaceNodes=surfaceNodes+[1 0];
...
for i=1:length(NodeInfo)
    if NodeInfo(i,1)==0+1 || NodeInfo(i,1)==xLength+1 || NodeInfo(i,2)==0 || NodeInfo(i,2)==yLength
        NodeInfo(i,3)=1;
        hold on
        plot(NodeInfo(i,1),NodeInfo(i,2),'go');
    end
...
fileID = fopen('96hWingDisc_smallMesh_symmetricY_posCoord.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_smallMesh_symmetricY_posCoord.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
fclose(fileID);
%% 20210705 96h wing disc experimental measures - small mesh - symmetricY - negative coordinates
clear all
close all
...
borderNodes=borderNodes-[147 0];
surfaceNodes=surfaceNodes-[147 0];
...
for i=1:length(NodeInfo)
    if NodeInfo(i,1)==0-147 || NodeInfo(i,1)==xLength-147 || NodeInfo(i,2)==yLength
        NodeInfo(i,3)=1;
        hold on
        plot(NodeInfo(i,1),NodeInfo(i,2),'go');
    end
...
fileID = fopen('96hWingDisc_smallMesh_symmetricY_posCoord_removedY0Nodes.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_smallMesh_symmetricY_posCoord_removedY0Nodes.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
fclose(fileID);
%% 20210705 96h wing disc experimental measures - large mesh - symmetricY - negative coordinates
clear all
close all
...
fileID = fopen('96hWingDisc_largeMesh_symmetricY_posCoord_removedY0Nodes.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_largeMesh_symmetricY_posCoord_removedY0Nodes.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
fclose(fileID);
%% 20210705 96h wing disc experimental measures - fine mesh - symmetricY - negative coordinates
clear all
close all
...
fileID = fopen('96hWingDisc_fineMesh_symmetricY_posCoord_removedY0Nodes.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_fineMesh_symmetricY_posCoord_removedY0Nodes.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
fclose(fileID);
%% 20210705 96h wing disc experimental measures - small mesh - negative coordinates
clear all
close all
...
fileID = fopen('96hWingDisc_smallMesh_symmetricY_negCoord.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_smallMesh_symmetricY_negCoord.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
...
fileID = fopen('96hWingDisc_smallMesh_posCoord.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_smallMesh_posCoord.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
fclose(fileID);
%% 20210705 96h wing disc experimental measures - large mesh - positive coordinates
clear all
close all
...
fileID = fopen('96hWingDisc_largeMesh_posCoord.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_largeMesh_posCoord.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
fclose(fileID);
%% 20210705 96h wing disc experimental measures - fine mesh - positive coordinates
clear all
close all
...
fileID = fopen('96hWingDisc_fineMesh_posCoord.node','w');
fprintf(fileID,'%d %d %d %d\n',[length(NodeInfo),2,0,1]); %number of nodes
for i=1:length(NodeInfo)
    fprintf(fileID,'%d %.4f %.4f %d\n',[i-1,NodeInfo(i,:)]);
end
...
fileID = fopen('96hWingDisc_fineMesh_posCoord.ele','w');
fprintf(fileID,'%d %d %d\n',[length(ConnectionInfo),3,0]); %number of connections
for i=1:length(ConnectionInfo)
    fprintf(fileID,'%d %d %d %d \n',[i-1, ConnectionInfo(i,1)-1,ConnectionInfo(i,2)-1,ConnectionInfo(i,3)-1]);
end
