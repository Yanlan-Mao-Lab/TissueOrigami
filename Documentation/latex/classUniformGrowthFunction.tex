...
This function will write the \hyperlink{classUniformGrowthFunction_af78591902b0cc391a62f3093fd14ad10}{Uniform\+Growth\+Function\+::\+Growth\+Rate} of the current growth function to the input double array pointer. The double array pointer should be set to point at a double array of size 3 (or higher) before calling the function.
