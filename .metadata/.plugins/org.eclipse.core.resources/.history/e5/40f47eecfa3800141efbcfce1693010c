...
protected:
	...
	double* CurrPlasticStrainAddition;
...
public:
	...
	boost::numeric::ublas::vector<double> GrowthStrain;
	boost::numeric::ublas::vector<double> LocalGrowthStrain;
	boost::numeric::ublas::vector<double> ShapeChangeStrain;
	boost::numeric::ublas::vector<double> LocalPlasticStrains;
	int alingmentTurn;
	...
	void getGrowthStrain(int type, float &StrainMag);
	...
	void calculateGrowthRotationMatrixToReference();
